...
public class CarreraController {
	...
	public String getNuevaCarreraPage(Model model) {
		...
		model.addAttribute("titulo", "NuevaCarrera");
		return "carrera";
	}
	
	@PostMapping("/guardar")
	public ModelAndView guardarCarerra(@ModelAttribute("carrera") Carrera carrera) {
		ModelAndView modelView = new ModelAndView("carreras");
		carrera.setEstado(true);
		CollectionCarrera.setCarrera(carrera);
		modelView.addObject("carreras", CollectionCarrera.getListaCarreras());
		return modelView;
	}
